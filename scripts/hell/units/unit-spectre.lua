...
local SpectreStill = {"frame 5", "wait 4", "random-goto 99 no-rotate", "frame 10", "wait 4",
"frame 15", "wait 4","frame 0", "wait 4","random-rotate 1", "label no-rotate", "wait 1",}
local SpectreMove = {"unbreakable begin",
...
local SpectreDeath = {"unbreakable begin", 
	...
	"exact-frame 40", "spawn-unit unit-spectre-body 0 0 2 15 summoned",
...
local SpectreDeathExtreme = {"unbreakable begin", 
...
DefineAnimations("animations-spectre-body", {
  ...
  "spawn-unit unit-spectre 0 0 2 v_RessurectPlayer.Value jointoai.summoned", "goto end",
...
DefineAnimations("animations-spectre", {
  Still = SpectreStill,
  Move = SpectreMove,
  Upgrade = SpectreStill,
  ...
  "label end",
    "frame 0", "unbreakable end", "wait 1",},
  Death = SpectreDeath,
  Death_extreme = SpectreDeathExtreme,
})

UnitName = "unit-spectre"
BaseDamage = UnitInfo(UnitName, const.Unit_BaseDmg)
DamageType = UnitInfo(UnitName, const.Unit_DamageType)
DefineUnitType(UnitName, { Name = _("Spectre"),
  -- Drawing
  Image = {"file", "graphics/hell/units/spectre.png", "size", {52, 52}},
  Animations = "animations-spectre", Icon = "icon-spectre",
...
DefineUnitType("unit-spectre-body", { Name = _("Spectre Body"),
  Image = {"file", "graphics/hell/units/spectre.png", "size", {52, 52}},
  Animations = "animations-spectre-body", Icon = "icon-demon",
  HitPoints = 120,
  DrawLevel = 10,
  Indestructible = 1,
  NeedToResurrect = 2,
