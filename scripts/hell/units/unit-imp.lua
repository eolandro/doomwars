...
local ImpStill = {"frame 5", "wait 4", "random-goto 99 no-rotate","frame 10", "wait 4","frame 15", "wait 4", 
"frame 0", "wait 4","random-rotate 1", "label no-rotate", "wait 1",}
local ImpMove = {"unbreakable begin", 
...
local ImpDeath = {"unbreakable begin", 
	"frame 35", "spawn-missile missile-gibs 20 20 0 0 pixel", "wait 4", 
	"frame 40", "wait 4",
	"frame 45", "wait 4", 
	"frame 50", "wait 4", 
	"frame 55", "spawn-unit unit-imp-body 0 0 2 15 summoned", 
...
local ImpDeathExtreme = {"unbreakable begin", 
	"exact-frame 60", "spawn-missile missile-extreme-gibs 20 20 0 0 pixel", "wait 4",
	"exact-frame 61", "wait 4",
	"exact-frame 62", "wait 4",
	"exact-frame 63", "wait 4", 
	"exact-frame 64", "wait 4", 
	"exact-frame 65", "wait 4",
	"exact-frame 66", "wait 4",
	"exact-frame 67", "wait 2000",
    "exact-frame 67", "unbreakable end", "wait 1",}

DefineAnimations("animations-imp-body", {
  Still = {"label begin","frame 55","if-var v_Arg1.Value > 0 still", "frame 55","wait 1", "goto end", 
  "label ressurect", 
  ...
  "frame 40","wait 3",
  "frame 35","wait 3",
  "spawn-unit unit-imp 0 0 2 v_RessurectPlayer.Value jointoai.summoned", "goto end",
  "label diedemon", "die demon_eating","wait 2",	
  "label still","frame 55", "wait 1", 
  ...
  Death = {"unbreakable begin","frame 55","wait 2","unbreakable end","wait 1",},
  Death_ressurect = {"unbreakable begin","exact-frame 55","unbreakable end","wait 1",},
  Death_demon_eating = {"unbreakable begin","exact-frame 55","spawn-missile missile-gibs 20 20 0 0 pixel","wait 3","unbreakable end","wait 1",}
})
	
DefineAnimations("animations-imp", {
  Still = ImpStill,
  Move = ImpMove,
  Attack = {"unbreakable begin", "frame 20", "wait 3", "frame 25", "wait 3", "frame 30", 
  "set-var DamageType 0 fire",
  ...
  "spawn-missile missile-imp-ball-elite 0 0 0 0 damage.totarget", "goto next",
  "label normal",
  "attack", 
  "label next",
  ...
  "set-var HeavyBuildingArmorDamage.Value 0 v_HeavyBuildingArmorDamage2.Value",
  "set-var CursedArmorDamage.Value 0 v_CursedArmorDamage2.Value",
  "attack", "sound fireball launch", "wait 5",
    "frame 0", "wait 14", "frame 0",
	"label end","unbreakable end", "wait 1",},
  Death = ImpDeath,
  Death_extreme = ImpDeathExtreme,
})
...
DefineUnitType(UnitName, { Name = _("Imp"),
  -- Drawing
  Image = {"file", "graphics/hell/units/doomimp.png", "size", {44, 44}},
  Shadow = {"file", "graphics/hell/units/doomimp-s.png", "size",{44, 44},"offset", {0, 0}},
  Animations = "animations-imp", Icon = "icon-imp",
  ...
  PoisonDrain = 1,
  DamageType = "fire",
  CanCastSpell = {"spell-melee-attack", "spell-burn", "spell-burn-for-ai"},
...
DefineUnitType("unit-imp-body", { Name = _("Imp Body"),
  Image = {"file", "graphics/hell/units/doomimp.png", "size", {44, 44}},
  Animations = "animations-imp-body", Icon = "icon-imp",
  HitPoints = 100,
  DrawLevel = 10,
  Indestructible = 1,
  NeedToResurrect = 2,
