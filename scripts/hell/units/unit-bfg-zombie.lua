...
local ZombieBFGStill = {"frame 5", "wait 4", "random-goto 99 no-rotate", "frame 10", "wait 4",
"frame 15", "wait 4","frame 0", "wait 4","random-rotate 1", "label no-rotate", "wait 1",}
local ZombieBFGMove = {"unbreakable begin",
...
local ZombieBFGDeath = {"unbreakable begin", 
	...
	"exact-frame 36", "spawn-unit unit-zombie-bfg-body 0 0 2 15 summoned", 
...
local ZombieBFGDeathExtreme = {"unbreakable begin", 
...
DefineAnimations("animations-zombie-bfg", {
  Still = ZombieBFGStill,
  Move = ZombieBFGMove,
  Attack = {"unbreakable begin", 
  "frame 20", "sound bfg charge", "wait 38", 
  "frame 25", 
  ...
  "frame 0", "wait 10", "sound bfg reload", "wait 85", 
  "unbreakable end", "wait 1",},
  Death = ZombieBFGDeath,
  Death_fire = {"unbreakable begin","exact-frame 44","spawn-unit unit-burning 0 0 5 15","wait 100","unbreakable end","wait 1",},
  Death_extreme = ZombieBFGDeathExtreme,
})

DefineAnimations("animations-zombie-bfg-body", {
  ...
  "spawn-unit unit-zombie-bfg 0 0 2 v_RessurectPlayer.Value jointoai.summoned", "goto end",
...
UnitName = "unit-zombie-bfg"
BaseDamage = UnitInfo(UnitName, const.Unit_BaseDmg)
DamageType = UnitInfo(UnitName, const.Unit_DamageType)
DefineUnitType("unit-zombie-bfg", { Name = _("Former Commando"),
  -- Drawing
  Image = {"file", "graphics/hell/units/bfgzombie.png", "size", {50, 50}},
  Animations = "animations-zombie-bfg", Icon = "icon-zombie-bfg",
  Shadow = {"file", "graphics/hell/units/bfgzombie-s.png", "size",{50, 50},"offset", {0, 0}},
...
DefineUnitType("unit-zombie-bfg-body", { Name = _("Former Commando Body"),
  Image = {"file", "graphics/hell/units/bfgzombie.png", "size", {50, 50}},
  Animations = "animations-zombie-bfg-body", Icon = "icon-zombie-bfg",
  HitPoints = 100,
  DrawLevel = 10,
  Indestructible = 1,
  NeedToResurrect = 2,
