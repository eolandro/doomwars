function RunDiplomacyMenu()
  ...
  for i=0,14 do
    if (Players[i].Type ~= PlayerNobody and ThisPlayer.Index ~= i) then
      ...
      alliedcb = menu:addImageCheckBox("", 126, (18 * j) + 23, g_checkbox_off, g_checkbox_on,
        function()
      ...
      enemycb = menu:addImageCheckBox("", 186, (18 * j) + 23, g_checkbox_off, g_checkbox_on,
        function()
          if (alliedcb:isMarked() and enemycb:isMarked()) then
      ...
      sharedvisioncb = menu:addImageCheckBox("", 276, (18 * j) + 23, g_checkbox_off, g_checkbox_on,
        function() end)
