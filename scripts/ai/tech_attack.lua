...
local tech_funcs_medium = {
		...
		function() return AiSet("unit-robotworker", 20) end,
		function() return AiResearch("upgrade-armor1") end,
		function() return AiForce(0, {"unit-shotgunner", 1, "unit-chaingunner", 2, "unit-technician",1}) end,
		function() return AiSet("unit-chaingun-tower", 2) end,
		...
		function() return AiForce(1, {"unit-technician", 2, "unit-rocketmarine", 2, "unit-medic", 1, "unit-raider", 2, "unit-uac-fighter", 2}, true) end,
		function() return AiNeed("unit-tech-center") end,
		function() return AiWait("unit-tech-center") end,
		...
		function() return AiForce(1, {"unit-technician", 2, "unit-rocketmarine", 2, "unit-plasmamarine", 4, "unit-medic", 1, 
			"unit-raider", 2, "unit-crusher", 3, "unit-uac-fighter", 2}, false) end,
		function() return AiWaitForce(1) end,
		function() return AiAttackWithForce(1) end,
