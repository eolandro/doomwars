...
---------------------------------------------------
local end_loop_complex_funcs2_easy = {
		...
		function() ai_complex_attack_end_loop_func[complexplayer] = 0; return false end,
}

local end_loop_complex_funcs2_medium = {
		function() print("Looping !") return false end,
...
local end_loop_complex_funcs2_hard = {
		function() print("Looping !") return false end,
...
local end_loop_complex_funcs_easy = {
		function() print("Looping !") return false end,
...
local end_loop_complex_funcs_medium = {
		function() print("Looping !") return false end,
...
local end_loop_complex_funcs_hard = {
		function() print("Looping !") return false end,
		function() SetPlayerData(AiPlayer(), "Resources", "minerals", GetPlayerData(AiPlayer(), "Resources", "minerals") + 10000)
				   SetPlayerData(AiPlayer(), "Resources", "energy", GetPlayerData(AiPlayer(), "Resources", "energy") + 2500)
				   return false end,
...
function AiComplexAttackEndloop2()
  ...
  while (true) do
	ret = end_loop_complex_funcs2[difficulty][ai_complex_attack_end_loop_func[complexplayer]]()
	if (ret) then
	  break
	end
...
function AiComplexAttackEndloop()
  ...
  while (true) do
	ret = end_loop_complex_funcs[difficulty][ai_complex_attack_end_loop_func[complexplayer]]()
	if (ret) then
	  break
	end
	ai_complex_attack_end_loop_func[complexplayer] = ai_complex_attack_end_loop_func[complexplayer] + 1
